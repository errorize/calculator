...
public class MainFrame extends JFrame {
    ...
    private final PermutationAction permutationAction = new PermutationAction();
    private JLabel lbl_inputFormatTip = new JLabel("input format must be like this: 2 3.");
    private JLabel lbl_inputFormatTip2 = new JLabel("input digits:");
    private JTextField tf_input = new JTextField();
    private JButton btn_calc = new JButton("go");
    private JButton btn_store = new JButton("save log");
    private JTextArea ta_log = new JTextArea();
    private JFileChooser fc_chooseFilePath = new JFileChooser();
...
//        ta_log.setBorder(new EmptyBorder(5, 5, 5, 5));
        ...
        btn_store.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String filePath = fc_chooseFilePath.getSelectedFile().getAbsolutePath() 
        ...
        try {
            permutationAction.loadSystemProperties();
        } catch (Exception e) {
